const Contact = ({width}) => {
    ...
    return <div className="contact" id="contact">
                ...
                <div className="contact-wrapper">
                    <p>I currently work at BPS Consultores and I have some freelance projects in progress, but I am always available to listen to job offers...</p>
                    <ul>
                        <li>
                        ...
                        <li>
                            <a href="mailto:kristtianvega@gmail.com" >
